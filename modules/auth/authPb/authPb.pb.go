...
const file_modules_auth_authPb_authPb_proto_rawDesc = "" +
	...
	"\x05count\x18\x01 \x01(\x03R\x05count2\x81\x01\n" +
	"\x0fAuthGrpcService\x12@\n" +
	"\x10CredentialSearch\x12\x15.AccessTokenSearchReq\x1a\x15.AccessTokenSearchRes\x12,\n" +
	"\n" +
	"RolesCount\x12\x0e.RolesCountReq\x1a\x0e.RolesCountResB'Z%github.com/pitipon/shop-microservicesb\x06proto3"
